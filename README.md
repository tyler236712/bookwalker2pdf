When viewing the manga you want to download on bookwalker, inspect element the page, go to the console tab, and Copy and paste [this](bookwalker.js) script into the console. 
